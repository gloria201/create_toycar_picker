...
class NavTest():  
    def __init__(self):  
        ...
        locations = dict()            
        locations['pose 1'] = Pose(Point(0.000, 0.300, 0.000), Quaternion(0.000, 0.000, 0.223, 0.975))  
        locations['pose 2'] = Pose(Point(1.994, 0.300, 0.000), Quaternion(0.000, 0.000, -0.670, 0.743))  
